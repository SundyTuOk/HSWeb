...
public class TargetWaterDao
{
	 ...
	 * @throws SQLException 
	 */
	public TargetWaterModel queryByID(int targetID) throws SQLException
	{
		TargetWaterModel taModel=null;
		String sql="Select * from TargetWater Where Target_ID="+targetID;
...
//		}
	 ...
	 * @param TargetStyle	对象类型,2:建筑
	 * @param TargetYear	年份
	 * @param energyFenlei	分项
	 * @return	结果集
	 * @throws SQLException
	 */
	public TargetWaterModel queryByIndex(String TargetIndex,int TargetStyle,int TargetYear,String energyFenlei) throws SQLException
	{
		TargetWaterModel taModel= new TargetWaterModel();
		String sql="Select * from TargetWater Where Target_Index='"+TargetIndex +"' and Target_Style="+TargetStyle+" and Target_Year="+TargetYear+" and Target_Fenlei='"+energyFenlei+"'";
		Connection conn=null;
		PreparedStatement ps =null;
		ResultSet rs = null;
...
//		}
	...
	/**
	 * 新增指标数据
	 * @param TargetWaterModel
	 * @return 是否操作成功
	 * @throws SQLException 
	 */
	public boolean insert(TargetWaterModel taModel) throws SQLException
	{
		String sql = "INSERT INTO TargetWater(TARGET_INDEX,TARGET_STYLE,TARGET_FENLEI,TARGET_NAME,TARGET_YEAR,TARGET_JAN,TARGET_FEB,TARGET_MAR," +
...
//		}
	...
	{
		String sql="delete  from TargetWater Where Target_Index='"+TargetIndex +"' and Target_Style="+TargetStyle+" and Target_Year="+TargetYear+" and Target_Fenlei='"+energyFenlei+"'";
		Connection conn=null;
		PreparedStatement ps =null;
		boolean b=false;
		try
