 ...
 *
 */
public class TargetWaterModel
{	

	private int targetID=0;
	private String targetIndex="";
	private int targetStyle=0; //1全校、 2建筑类别、3建筑、4区域、5部门
	private String targetFenlei=" ";
	private String targetName=" ";
	private float targetYear=0;
	private float m1=0;
	private float m2=0;
	private float m3=0;
	private float m4=0;
	...
	public float getTargetYear()
	{
		return targetYear;
	}
	public void setTargetYear(float targetYear)
	{
