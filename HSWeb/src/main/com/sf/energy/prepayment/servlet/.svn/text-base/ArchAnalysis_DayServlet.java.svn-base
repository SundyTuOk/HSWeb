...
import com.sf.energy.prepayment.dao.ArchAnalysis_DayDao;

public class ArchAnalysis_DayServlet extends HttpServlet
{
	...
	{
		ArchAnalysis_DayDao aadd = new ArchAnalysis_DayDao();
		...
		String queryInfo = queryStyle + "|" + queryYear + "|" + queryMonth;
		
		String resultInfo = "";
		resultInfo = aadd.getTableStr(selectInfo, queryInfo);
			...
			HttpServletResponse response) throws IOException, SQLException
	{
		...
		String resultInfo = "";
		resultInfo = aadd.getFusionChartsStr(selectInfo, queryInfo);
