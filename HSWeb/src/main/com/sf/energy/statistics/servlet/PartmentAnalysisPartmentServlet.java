...
public class PartmentAnalysisPartmentServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(request.getParameter("partmentIDList") !=null ){
			...
			if(!request.getParameter("partmentIDList").isEmpty())
			{
		...
		//System.out.println("partment : "+PartmentContrastdata);
