...
public class PartmentAnalysisFenlei extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ElecReportHelperImpl  rhi_PartmentTimeFenlei_fenxiang = new ElecReportHelperImpl();
		ElecReportHelperImpl  rhi_PartmentTimeFenlei_style = new ElecReportHelperImpl();
		
		if(selectPartmentID == -1||selectPartmentID ==0)
		{
			try {
				list_dp = dpDao.display();//获取所有部门的ID信息
				for(int i = 0;i<list_dp.size();i++)
				{
					...
					Value_fenxiang1+=PartmentTimeFenlei_fenxiangmap.get("特殊用电");
					Value_fenxiang2+=PartmentTimeFenlei_fenxiangmap.get("空调用电");
					Value_fenxiang3+=PartmentTimeFenlei_fenxiangmap.get("照明插座");
					Value_fenxiang4+=PartmentTimeFenlei_fenxiangmap.get("动力用电");
					Value_fenxiang11+=PartmentTimeFenlei_fenxiangmap1.get("特殊用电");
					Value_fenxiang22+=PartmentTimeFenlei_fenxiangmap1.get("空调用电");
					Value_fenxiang33+=PartmentTimeFenlei_fenxiangmap1.get("照明插座");
					Value_fenxiang44+=PartmentTimeFenlei_fenxiangmap1.get("动力用电");
				...
				PartmentTimeFenlei_fenxiangmap.put("特殊用电", Value_fenxiang1);
				PartmentTimeFenlei_fenxiangmap.put("空调用电", Value_fenxiang2);
				PartmentTimeFenlei_fenxiangmap.put("照明插座", Value_fenxiang3);
				PartmentTimeFenlei_fenxiangmap.put("动力用电", Value_fenxiang4);
				PartmentTimeFenlei_fenxiangmap1 = new HashMap<String, Float>();
				PartmentTimeFenlei_fenxiangmap1.put("特殊用电", Value_fenxiang11);
				PartmentTimeFenlei_fenxiangmap1.put("空调用电", Value_fenxiang22);
				PartmentTimeFenlei_fenxiangmap1.put("照明插座", Value_fenxiang33);
				PartmentTimeFenlei_fenxiangmap1.put("动力用电", Value_fenxiang44);
