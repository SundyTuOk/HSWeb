...
public class PartmentAnalysisTimeServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		{
			ElecReportHelperImpl  rhi_PartmentTimeContrast_year = new ElecReportHelperImpl();
			...
			ElecReportHelperImpl  rhi_PartmentTimeContrast_day = new ElecReportHelperImpl();
