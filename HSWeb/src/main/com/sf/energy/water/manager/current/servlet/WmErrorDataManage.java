...
import com.sf.energy.water.manager.current.dao.WatermeterErrorDataDao;

public class WmErrorDataManage extends HttpServlet
{
	...
	{
		WatermeterErrorDataDao admd = new WatermeterErrorDataDao();
			...
			IOException
	{
		...
		//System.out.println("水:"+type+":"+data);
		out.println(data);
		out.flush();
		out.close();
	}
