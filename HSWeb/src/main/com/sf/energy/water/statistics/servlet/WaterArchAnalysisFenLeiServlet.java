...
public class WaterArchAnalysisFenLeiServlet extends HttpServlet {
...
//				//System.out.println("ttt:"+allArcIDlist);
				WaterReportHelperImpl  rhi_ArcTimeFenlei_fenxiang = new WaterReportHelperImpl();
				WaterReportHelperImpl  rhi_ArcTimeFenlei_style = new WaterReportHelperImpl();
				try {
...
//						//System.out.println("zzz"+allArcIDlist.get(i).intValue());
						...
						Value_fenxiang1+=ArcTimeFenlei_fenxiangmap.get("食堂餐厅");
						Value_fenxiang2+=ArcTimeFenlei_fenxiangmap.get("公共洗手间");
						Value_fenxiang3+=ArcTimeFenlei_fenxiangmap.get("澡堂淋浴");
						Value_fenxiang4+=ArcTimeFenlei_fenxiangmap.get("消防浇灌");
						Value_fenxiang11+=ArcTimeFenlei_fenxiangmap1.get("食堂餐厅");
						Value_fenxiang22+=ArcTimeFenlei_fenxiangmap1.get("公共洗手间");
						Value_fenxiang33+=ArcTimeFenlei_fenxiangmap1.get("澡堂淋浴");
						Value_fenxiang44+=ArcTimeFenlei_fenxiangmap1.get("消防浇灌");
					...
					ArcTimeFenlei_fenxiangmap.put("食堂餐厅", Value_fenxiang1);
					ArcTimeFenlei_fenxiangmap.put("公共洗手间", Value_fenxiang2);
					ArcTimeFenlei_fenxiangmap.put("澡堂淋浴", Value_fenxiang3);
					ArcTimeFenlei_fenxiangmap.put("消防浇灌", Value_fenxiang4);
					ArcTimeFenlei_fenxiangmap1 = new HashMap<String, Float>();
					ArcTimeFenlei_fenxiangmap1.put("食堂餐厅", Value_fenxiang11);
					ArcTimeFenlei_fenxiangmap1.put("公共洗手间", Value_fenxiang22);
					ArcTimeFenlei_fenxiangmap1.put("澡堂淋浴", Value_fenxiang33);
					ArcTimeFenlei_fenxiangmap1.put("消防浇灌", Value_fenxiang44);
