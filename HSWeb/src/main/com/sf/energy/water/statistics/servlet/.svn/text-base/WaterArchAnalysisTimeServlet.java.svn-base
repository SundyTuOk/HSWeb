...
public class WaterArchAnalysisTimeServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		WaterReportHelperImpl  rhi_ArcTimeContrast_year = new WaterReportHelperImpl();
		Map<String,List<Float>> ArcTimeContrast_yearmap = new HashMap<String,List<Float>>();//年份返回值
		WaterReportHelperImpl  rhi_ArcTimeContrast_month = new WaterReportHelperImpl();
