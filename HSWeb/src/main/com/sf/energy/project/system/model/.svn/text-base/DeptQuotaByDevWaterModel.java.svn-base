...
public class DeptQuotaByDevWaterModel
{
	// /值ID
	private int valueID;
	// /部门ID
	...
	public double getRunHoursPerMth()
	{
		return RunHoursPerMth;
	}
	public void setRunHoursPerMth(double runHoursPerMth)
	{
		RunHoursPerMth = runHoursPerMth;
	}
