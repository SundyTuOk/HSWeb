...
public class PYnoBalance
{
	...
	public RateNoModel CountRateNo(int am_ID,int year,int month,int day,int hour) throws SQLException 
	{
		...
		list = apdd.getPYNobalancedata(am_ID, year, month, day, hour);
		if(list.size() == 0)
		{
			rnm.setCount(0);
			rnm.setCount5(0);
		...
		{ 
			if(list.get(i).getPYrate() < 5)
			{
				count5 = count5 + 1;
			}else if(list.get(i).getPYrate() > 5 && list.get(i).getPYrate() <= 10)
			{
				count510 = count510 + 1;
			}else if(list.get(i).getPYrate() > 10 && list.get(i).getPYrate() <=20)
			{
				count1020 = count1020 + 1;
			}else if(list.get(i).getPYrate() > 20)
			{
				count20 = count20 + 1;
			}
		}
	...
	public RateNoModel CountAllRateNo(int year,int month,int day,int hour) throws SQLException 
	{
		...
		list = apdd.getAllPYNobalancedata(year, month, day, hour);
		if(list.size() == 0)
		{
			rnm.setCount(0);
			rnm.setCount5(0);
